...
import com.springjwt.springbootsecurityjwt.payload.request.LoginRequest;
import com.springjwt.springbootsecurityjwt.payload.request.SignupRequest;
import com.springjwt.springbootsecurityjwt.payload.response.JwtResponse;
import com.springjwt.springbootsecurityjwt.payload.response.MessageResponse;
import com.springjwt.springbootsecurityjwt.repository.RoleRepository;
import com.springjwt.springbootsecurityjwt.repository.UserRepository;
import com.springjwt.springbootsecurityjwt.security.jwt.JwtUtils;
...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    if (strRoles == null) {
      Role userRole = roleRepository.findByName(ERole.ROLE_BLOGGER)
